...
mod tests {
    ...
    // #[test]
    // fn parse_pi() {
    //     // Known accurate pi to 50 digits
    //     let pi_string = "3.14159265358979323846264338327950288419716939937510";
    //     let pi_a: DoubleDouble = pi_string.parse().unwrap();
    //     println!("{:?}", pi_a);

    //     // Taken directly from the constants in a known-accurate double-double Python package
    //     let pi_b = DoubleDouble(3.141592653589793e+00, 1.224646799147353e-16);
    //     println!("{:?}", pi_b);

    //     assert_eq!(pi_a, pi_b);

    //     let e_string = "1.57079632679489661923132169163975144";
    //     let e: DoubleDouble = e_string.parse().unwrap();
    //     println!("{:?}", e);
    // }
    ...
    fn test_length() {
        ...
        println!("{}", DoubleDouble::PI);
    }

    #[test]
    fn test_display() {
        println!("{:e}", DoubleDouble::PI);
    }

    #[test]
    fn test_to_string() {
        println!("{}", DoubleDouble::PI.to_string());
    }
