...
impl Quad {
    ...
    pub const LOG2_E: Quad = Quad(
        ...
        -1.38367167801814e-50,
    );

    /// log 2
    pub const LOG102: Quad = Quad(
        3.010299956639812e-1,
        -2.8037281277851704e-18,
        5.471948402314639e-35,
        5.1051389831070984e-51,
    );
