...
impl Quad {
    ...
    pub fn sqr(self) -> Quad {
        if self.is_infinite() {
            ...
            // A considerable simplification over simply multiplying the number
            // by itself, with the simplifications possible because the two
            // numbers being multiplied are in fact equal.
            //
            ...
            // Less primitive functions are not used here because there are
            // steps in them that can be skipped.
